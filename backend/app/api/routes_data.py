...
from app.schemas.responses import DatasetUploadResponse, SelectRowResponse
...
async def select_row(request: SelectRowRequest) -> SelectRowResponse:
    try:
        ...
        feature_vector = extract_feature_vector_from_row(
            ...
            request.row_index,
            session.model.feature_names,
        )
        prepared_feature_vector, prediction_result = predict_model(session.model, feature_vector)
